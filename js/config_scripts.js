        ...
        (initCustomStyleCopy = function () {
            $('#mybootstrap .wpse-customstyles-items a.copy').unbind('click').click(function (e) {
                ...
                $.ajax({
                    ...
                    success: function (res, stt) {
                        if (stt === 'success') {
                            $(that).parents('.wpse-customstyles-list').find('li').last().before('<li class="wpse-customstyles-items" data-id-customstyle="' + res.id + '"><a><i class="wpseicon-quill"></i> <span class="wpse-customstyles-name">' + res.title + '</span></a><a class="copy"><i class="wpseicon-copy"></i></a><a class="trash"><i class="wpseicon-trash"></i></a><ul style="margin-left: 30px"><li class="wpse-customstyles-items-class">('+ res.name +')</li></ul></li>');
                            initCustomStyleMenu();
                        } else {
                            alert(stt);
                        }
