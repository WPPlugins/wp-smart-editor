...
<div id="profile-tabs">
    <ul class="tabs cyan z-depth-1">
        <li class="tab"><a href="#tabs-1" class="link-tab white-text waves-effect waves-light"><?php _e('Editor toolbars', 'wp-smart-editor') ?></a></li>
        <li class="tab"><a href="#tabs-2" class="link-tab white-text waves-effect waves-light"><?php _e('Profile attribution', 'wp-smart-editor') ?></a></li>
    </ul>

    <!--Editor toolbars tab-->
    <div id="tabs-1" class="active tabs-content">
                ...
                <?php foreach ($toolbar_btns as $toolbar => $list_btns) : ?>
                    <?php $toolbar_inused = !in_array('unused', explode(' ', $list_btns));
                        ...
                        if ( !$toolbar_inused && $unused == 1 || $toolbar == 'unused_toolbar1' && $list_btns == '') {
                            echo '</div><h3>'. __("Editors Tools Avaiable", 'wp-smart-editor') . '</h3>
